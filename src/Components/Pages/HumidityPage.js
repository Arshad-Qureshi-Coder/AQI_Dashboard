...
export const HumidityPage = () => {
  ...
  // Filter temperature-related components from ComponentMap
  const tempComponents = ComponentMap.filter(component => component.category === 'humidity');
...
const handleClose = () => setShowModal(false);
  ...
  return (
    <div className=" py-4" style={{fontSize:'20px', fontWeight:'bold', color:'Gray'}}>
      <span>Humidity Monitoring Dashboard</span>
  <div className="row">
        ...
        <div className="card">
          <div className="card-body">
            <h5 className="card-title "style={{fontSize:'15px', fontWeight:'bold', color:'Gray'}}>
              {data.id.replace('humidity', 'Humidity ')}
            </h5>
            <hr />
